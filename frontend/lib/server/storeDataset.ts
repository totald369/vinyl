...
function mergeFromSourcesFallback(): StoreData[] {
  ...
  const jeonbukBuanTrashRows = readJsonArray<RawStoreRow>("stores.jeonbuk-buan-trash.json");
  const jeonbukJeongeupTrashRows = readJsonArray<RawStoreRow>(
    "stores.jeonbuk-jeongeup-trash.json"
  );
  const jeonbukGimjeTrashRows = readJsonArray<RawStoreRow>(
    "stores.jeonbuk-gimje-trash.json"
  );
  const jeonbukImsilTrashRows = readJsonArray<RawStoreRow>(
  ...
  const gyeongnamMiryangTrashRows = readJsonArray<RawStoreRow>(
    "stores.gyeongnam-miryang-trash.json"
  );
  const jeonnamYeosuTrashRows = readJsonArray<RawStoreRow>(
    "stores.jeonnam-yeosu-trash.json"
  );
  const jeonnamSuncheonTrashRows = readJsonArray<RawStoreRow>(
    "stores.jeonnam-suncheon-trash.json"
  );
  const jeonnamHwasunTrashRows = readJsonArray<RawStoreRow>(
    "stores.jeonnam-hwasun-trash.json"
  );
  const jeonnamWandoTrashRows = readJsonArray<RawStoreRow>(
    "stores.jeonnam-wando-trash.json"
  );
  const jeonnamYeongamTrashRows = readJsonArray<RawStoreRow>(
    "stores.jeonnam-yeongam-trash.json"
  );
  const jeonnamDamyangTrashRows = readJsonArray<RawStoreRow>(
    "stores.jeonnam-damyang-trash.json"
  );
  const jejuSeogwipoTrashRows = readJsonArray<RawStoreRow>(
