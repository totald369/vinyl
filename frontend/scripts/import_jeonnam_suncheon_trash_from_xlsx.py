#!/usr/bin/env python3
"""
전라남도 순천시 종량제봉투 판매업소 xlsx → stores.jeonnam-suncheon-trash.json

입력: 연번, 판매인지정소, 소재지(도로명 주소)

  python3 scripts/import_jeonnam_suncheon_trash_from_xlsx.py \\
    --input ~/Downloads/종량제봉투판매업소\\ 현황\\(2023.\\ 8.\\ 20.\\).xlsx
...
DEFAULT_INPUT = DL / "종량제봉투판매업소 현황(2023. 8. 20.).xlsx"
REF_DATE = "2023-08-20"
CACHE_VERSION = "v1"
