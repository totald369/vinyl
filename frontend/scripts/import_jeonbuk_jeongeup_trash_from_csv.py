#!/usr/bin/env python3
"""
전북특별자치도 정읍시 종량제봉투 판매소 CSV → stores.jeonbuk-jeongeup-trash.json

입력: 상호명, 소재지주소, 담당부서, 담당부서연락처, 데이터기준일자

  python3 scripts/import_jeonbuk_jeongeup_trash_from_csv.py \\
    --input ~/Downloads/전라북도\\ 정읍시_종량제봉투판매소\\ 현황_20231215.csv
...
DEFAULT_INPUT = DL / "전라북도 정읍시_종량제봉투판매소 현황_20231215.csv"
REF_DATE = "2023-12-15"
CACHE_VERSION = "v1"
...
def main() -> None:
    ...
    for r in csv.DictReader(text.splitlines()):
        ...
        addr_raw = collapse(r.get("소재지주소") or "")
